...
internal static partial class CSharpFactory
{
    ...
    public static Solution CreateSolutionUnchecked(params ProjectFile[] projects)
    {
        ...
        foreach (ProjectFile project in projects)
        {
            ...
            solution = solution.AddProject(projectId, project.Name, project.Name, LanguageNames.CSharp);
            ...
            solution = solution.WithProjectParseOptions(projectId, new CSharpParseOptions(LanguageVersion.CSharp10));
        }
