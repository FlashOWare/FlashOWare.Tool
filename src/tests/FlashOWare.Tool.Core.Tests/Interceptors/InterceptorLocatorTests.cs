...
public class InterceptorLocatorTests
{
    ...
    public async Task ListAsync_WithGenerator_ReturnsInterceptors()
    {
        ...
        //Assert
        ToolAssert.Equal(result,
            new InterceptorInfo($"FlashOWare.Tool.Core.Tests{DirectorySeparator}FlashOWare.Tool.Core.Tests.Analyzers.InterceptorGenerator{DirectorySeparator}Test.Invoker.Invoke.g.cs", 10, 30, "AutoGenerated.Interceptors.Interceptor()", new InterceptionInfo("CallSite.cs", 3, 9, "Test.Invoker.Invoke()"))
        );
    }
